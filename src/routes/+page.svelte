...
<div class="max-w-xl mx-auto px-4 py-8">
	<div class="flex items-center justify-between mb-6">
		...
		<div class="flex items-center gap-3">
			...
			<a href="https://github.com/andreferrazz/re-zero" target="_blank" rel="noopener noreferrer" title="View on GitHub" class="text-gray-400 hover:text-gray-600 transition-colors">
